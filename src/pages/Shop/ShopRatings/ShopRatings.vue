    ...
    <div class="ratings-content">
      <div class="overview">
        ...
        <div class="overview-right">
          ...
          <div class="delivery-wrapper"> <span class="title">送达时间</span> <span class="delivery">{{info.deliveryTime}} 分钟</span>
          </div>
        </div>
      </div>
      <div class="split"></div>
      <div class="ratingselect">
        <div class="rating-type border-1px">
          <span class="block positive"
                ...
                @click="setSelectType(2)"> 全部
            <span class="count">{{ratings.length}}</span>
          </span>
          <span class="block positive"
                :class="{active: selectType === 0}"
                @click="setSelectType(0)"> 满意
            <span class="count">{{positiveSize}}</span>
          </span>
          <span class="block negative"
                :class="{active: selectType === 1}"
                @click="setSelectType(1)"> 不满意
            <span class="count">{{ratings.length-positiveSize}}</span>
          </span>
        </div>
        <div class="switch"
             :class="{on: onlyShowText}"
             @click="toggleOnlyShowText"> <span class="iconfont icon-icon-test"></span> <span class="text">只看有内容的评价</span>
        </div>
      </div>
        ...
        <ul>
          <li class="rating-item"
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont"
                      :class="rating.rateType === 0 ? 'icon-like-' : 'icon-dislike-'"></span>
                <span class="item"
